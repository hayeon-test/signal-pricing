...
class PricingConfig:
    def __init__(self):
        ...
        self.features = [
            ...
            FeatureSpec("closing_price", InputTypes.TARGET, DataTypes.CONTINUOUS),
        ...
        self.train_range = (0, 539)
        self.valid_range = (360, 700)
        self.test_range = (600, 720)
        ...
        # Feature sizes
        self.static_categorical_inp_lens = [5]
